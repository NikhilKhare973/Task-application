...
const editTask = (e) => {
  ...
  imageUrl = parentNode.childNodes[3].childNodes[3];
  taskTitle = parentNode.childNodes[3].childNodes[3];
  taskDescription = parentNode.childNodes[3].childNodes[5];
  taskType = parentNode.childNodes[3].childNodes[7].childNodes[1];
  submitButton = parentNode.childNodes[5].childNodes[1];

  // console.log(taskTitle, taskDescription, taskType, submitButton , imageUrl);

  imageUrl.setAttribute("contenteditable", "true");
...
const saveEdit = (e) => {
  ...
  const imageUrl = parentNode.childNodes[3].childNodes[3];
